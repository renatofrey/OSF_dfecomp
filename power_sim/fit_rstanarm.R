...
for (i in 1:3) {
  ...
  if (i == 1) save(mod_rstan, DV_label, mcmc, estimates, task, job, d, d_real, n, mode, decs, simdecs, t1, t2, myseed, file=paste("output/", task, "/model_samplesize_", formatC(job, width=3, flag="0"), ".Rdata", sep=""))

  if (i == 2) save(mod_rstan, DV_label, mcmc, estimates, task, job, t1, t2, myseed, file=paste("output/", task, "/model_H_", formatC(job, width=3, flag="0"), ".Rdata", sep=""))
  
  if (i == 3) save(mod_rstan, DV_label, mcmc, estimates, task, job, t1, t2, myseed, file=paste("output/", task, "/model_Hexp_", formatC(job, width=3, flag="0"), ".Rdata", sep=""))
